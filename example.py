...
#symeteric_problems = [create_random_problem("Problem_Sym_"+str(i),i) for i in range(10,30)]
...
genetic_algorithm1 = GeneticAlgorithm(generations=1000, mutation_rate=0.05, population_size=200, elite_size=20)
genetic_algorithm2 = GeneticAlgorithm(name="GA2", generations=1000, mutation_rate=0.01, population_size=200, elite_size=20)
